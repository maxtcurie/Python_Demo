#From https://pythonprogramming.net/convolutional-neural-networks-deep-learning-neural-network-pytorch/
...
class DogsVSCats():
    ...
    DOGS = "C:/Dog_VS_Cat_Dataset/PetImages/Dog"
    TESTING = "C:/Dog_VS_Cat_Dataset/PetImages/Testing"
